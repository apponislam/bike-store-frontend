...
const AllProducts = () => {
    ...
    const handleBrandChange = (value: string) => setBrand(value === "all" ? "" : value);
    const handleCategoryChange = (value: string) => setCategory(value === "all" ? "" : value);
    const handleInStockChange = () => setInStock(true);
    const handleOutOfStockChange = () => setInStock(false);
    const handleResetFilters = () => {
        setSearchTerm("");
        setBrand("");
        setCategory("");
    ...
    return (
        <div className="container mx-auto my-10 px-4">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                {/* Products Grid - Right side on large screens */}
